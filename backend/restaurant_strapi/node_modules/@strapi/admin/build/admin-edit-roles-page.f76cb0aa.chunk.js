(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[2544],{64499:function(H,L,o){"use strict";o.d(L,{V:function(){return P}});var e=o(30126),v=o(20108);const P=(b={},O={})=>{const{id:A,...x}=b,{get:E}=(0,e.kY)();if(!A&&(O?.enabled===void 0||O?.enabled))throw new Error('"id" is a required argument');const{data:M,error:W,isError:a,isLoading:B,refetch:p}=(0,v.useQuery)(["roles",A,"permissions",x],async()=>{const{data:{data:S}}=await E(`/admin/roles/${A}/permissions`,{params:x});return S},O);return{permissions:M,error:W,isError:a,isLoading:B,refetch:p}}},86409:function(H,L,o){"use strict";o.d(L,{F:function(){return b}});var e=o(30126),v=o(67879),P=o(20108);const b=(O={},A={})=>{const{id:x="",...E}=O,{get:M}=(0,e.kY)(),{locale:W}=(0,v.Z)(),a=(0,e.Xe)(W,{sensitivity:"base"}),{data:B,error:p,isError:S,isLoading:F,refetch:g}=(0,P.useQuery)(["roles",x,E],async()=>{const{data:V}=await M(`/admin/roles/${x??""}`,{params:E});return V},A);let h=[];return x&&B?h=[B.data]:Array.isArray(B?.data)&&(h=B.data),{roles:h.sort((V,oe)=>a.compare(V.name,oe.name)),error:p,isError:S,isLoading:F,refetch:g}}},15570:function(H,L,o){"use strict";o.r(L),o.d(L,{CreatePage:function(){return Re},default:function(){return Se}});var e=o(32735),v=o(95162),P=o(64092),b=o(84642),O=o(91779),A=o(56932),x=o(77981),E=o(8365),M=o(10710),W=o(97037),a=o(2846),B=o(15367),p=o(30126),S=o(70788),F=o(14723),g=o(92802),h=o(86834),V=o.n(h),oe=o(67879),de=o(15062),re=o(53038),C=o(8471),pe=o(64499),X=o(30305),G=o(1283),_=o(91720),Ce=o(24346),xe=Ce.Ry().shape({name:Ce.Z_().required(p.I0.required),description:Ce.Z_().required(p.I0.required)});const ae=C.ZP.div`
...
`,mt=({availableActions:t,isActive:n,isGrey:r,isFormDisabled:s,label:i,onClickToggle:l,pathToData:c})=>{const[d,m]=(0,e.useState)(!1),{formatMessage:u}=(0,B.Z)(),{modifiedData:f,onChangeParentCheckbox:R,onChangeSimpleCheckbox:$}=(0,G.$_)(),N=()=>{m(U=>!U)},I=()=>{m(!1)},T=C()(f,c.split(".."),{}),y=(0,e.useMemo)(()=>Object.keys(T).reduce((U,q)=>(U[q]=X()(T[q],"conditions"),U),{}),[T]),{hasAllActionsSelected:k,hasSomeActionsSelected:D}=Oe(y),Z=(0,e.useMemo)(()=>Ht(t,f,c),[t,f,c]),te=Z.some(({hasConditions:U})=>U);return e.createElement(Ut,{isActive:n},e.createElement(lt,{isGrey:r},e.createElement(at,{isCollapsable:!0,isFormDisabled:s,label:i,checkboxName:c,onChange:R,onClick:l,someChecked:D,value:k,isActive:n},e.createElement(dt,{paddingLeft:2},n?e.createElement(oe.Z,null):e.createElement(de.Z,null))),e.createElement(h.k,{style:{flex:1}},Z.map(({actionId:U,hasConditions:q,hasAllActionsSelected:K,hasSomeActionsSelected:ye,isDisplayed:Ie,isParentCheckbox:se,checkboxName:Ee,label:Ke})=>Ie?se?e.createElement(ct,{key:U,justifyContent:"center",alignItems:"center"},q&&e.createElement(ut,null),e.createElement(V.C,{disabled:s,name:Ee,"aria-label":u({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${Ke} ${i}`}),onValueChange:$e=>{R({target:{name:Ee,value:$e}})},indeterminate:ye,value:K})):e.createElement(ct,{key:U,justifyContent:"center",alignItems:"center"},q&&e.createElement(ut,null),e.createElement(V.C,{disabled:s,indeterminate:q,name:Ee,onValueChange:$e=>{$({target:{name:Ee,value:$e}})},value:K})):e.createElement(Ne,{key:U}))),d&&e.createElement(le,{headerBreadCrumbs:[i,"Settings.permissions.conditions.conditions"],actions:Z,isFormDisabled:s,onClosed:I,onToggle:N})),e.createElement(Gt,null,e.createElement(ae,{onClick:N,hasConditions:te})))};mt.propTypes={availableActions:a().array.isRequired,isActive:a().bool.isRequired,isGrey:a().bool.isRequired,isFormDisabled:a().bool.isRequired,label:a().string.isRequired,onClickToggle:a().func.isRequired,pathToData:a().string.isRequired};var zt=mt;const Yt=g.ZP.span`
  color: ${({theme:t})=>t.colors.danger700};
  padding-left: ${({theme:t})=>t.spaces[1]}px;
`;var pt=()=>e.createElement(Yt,null,"*"),wt=(t,n)=>t.map(r=>{const s=Array.isArray(r.subjects)&&r.subjects.indexOf(n)!==-1;return{...r,isDisplayed:s}});const Xt=(0,g.ZP)(p.x)`
...
`,B=({children:p,disabled:S=!1,error:F,expanded:g=!1,hasErrorMessage:h=!0,id:V,onToggle:oe,toggle:de,size:re="M",variant:C="primary",shadow:pe})=>{const X=(0,O.M)(V),G=v.useMemo(()=>({expanded:g,onToggle:oe,toggle:de,id:X,size:re,variant:C,disabled:S}),[S,g,X,oe,re,de,C]);return(0,e.jsxs)(b.S.Provider,{value:G,children:[(0,e.jsx)(a,{"data-strapi-expanded":g,disabled:S,"aria-disabled":S,expanded:g,hasRadius:!0,variant:C,error:F,shadow:pe,children:p}),F&&h&&(0,e.jsx)(E.x,{paddingTop:1,children:(0,e.jsx)(A.Z,{variant:"pi",textColor:"danger600",children:F})})]})}},79624:function(H,L,o){"use strict";o.d(L,{v:function(){return b}});var e=o(74512),v=o(85612),P=o(77981);const b=({children:O,...A})=>{const{expanded:x,id:E}=(0,v.A)();if(!x)return null;const M=`accordion-content-${E}`,W=`accordion-label-${E}`,a=`accordion-desc-${E}`;return(0,e.jsx)(P.x,{role:"region",id:M,"aria-labelledby":W,"aria-describedby":a,...A,children:O})}},85612:function(H,L,o){"use strict";o.d(L,{A:function(){return P},S:function(){return v}});var e=o(32735);const v=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),P=()=>(0,e.useContext)(v)},9379:function(H,L,o){"use strict";o.d(L,{B:function(){return p}});var e=o(74512),v=o(91917),P=o(8471),b=o(9435),O=o(85612);const A=({expanded:S,disabled:F,variant:g})=>{let h="neutral100";return S?h="primary100":F?h="neutral150":g==="primary"&&(h="neutral0"),h};var x=o(43743),E=o(18129),M=o(84642),W=o(8365);const a=(0,P.ZP)(x.A)`
  text-align: left;
