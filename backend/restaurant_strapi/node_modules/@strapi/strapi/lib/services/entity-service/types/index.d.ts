...
import type { PartialEntity, Entity, Result, PaginatedResult } from '@strapi/strapi/lib/services/entity-service/types/result';

import type * as Params from '@strapi/strapi/lib/services/entity-service/types/params';

// TODO: Move params to @strapi/utils (related to convert-query-params)
export * as Params from '@strapi/strapi/lib/services/entity-service/types/params';

export * from '@strapi/strapi/lib/services/entity-service/types/result';
export * from '@strapi/strapi/lib/services/entity-service/types/plugin';
