"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[9600],{12584:function(K,h,t){t.d(h,{Z:function(){return c}});var e=t(32735),s=t(1690),Z=t(45037),m=t(27947),k=t(8365),O=t(84642),l=t(30126),I=t(60216),n=t.n(I),L=t(67879),U=t(53038),D=t(77981),x=t(14763),C=t(94997);const B=({tokenName:r,onClickDelete:i,tokenType:E})=>{const{formatMessage:g}=(0,L.Z)(),{trackUsage:T}=(0,l.rS)(),[p,y]=(0,e.useState)(!1),u=()=>{y(!1),T("willDeleteToken",{tokenType:E}),i()};return e.createElement(D.x,{paddingLeft:1,onClick:d=>d.stopPropagation()},e.createElement(x.h,{onClick:()=>{y(!0)},label:g({id:"global.delete-target",defaultMessage:"Delete {target}"},{target:`${r}`}),name:"delete",noBorder:!0,icon:e.createElement(C.Z,null)}),e.createElement(l.QH,{onToggleDialog:()=>y(!1),onConfirm:u,isOpen:p}))};B.propTypes={tokenName:n().string.isRequired,onClickDelete:n().func.isRequired,tokenType:n().string.isRequired};var W=B,F=t(10364),J=t(8471);const Q={edit:{id:"app.component.table.edit",defaultMessage:"Edit {target}"},read:{id:"app.component.table.read",defaultMessage:"Read {target}"}},z=(0,J.ZP)(l.rU)`
  svg {
    path {
